const contactInfo = [
  {
    label: "Email",
    value: "Hostnellieandevents@gmail.com",
    href: "mailto:Hostnellieandevents@gmail.com",
  },
  {
    label: "Viber / WhatsApp",
    value: "+63 992 618 6313",
    href: "tel:+639926186313",
  },
  {
    label: "Instagram",
    value: "@hostnellie",
    href: "https://instagram.com/hostnellie",
  },
  {
    label: "Facebook",
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-warm-gray leading-relaxed mb-8">
              Whether you&apos;re planning a wedding, a corporate event, or
              something in between — reach out and let&apos;s see how Nellie
            ...
            <ul className="space-y-5">
              {contactInfo.map((item) => (
                <li key={item.label} className="flex gap-4 items-start">
                  <span className="text-gold text-xs tracking-widest uppercase w-24 pt-0.5 shrink-0">
                    {item.label}
                  </span>
                  <a
                    href={item.href}
          ...
          <div className="bg-cream p-8 border-l-2 border-gold">
            ...
            <p className="text-warm-gray text-sm leading-relaxed mb-6">
              Use the booking calendar above to reserve a consultation slot.
              Nellie typically responds within 24 hours.
            </p>
            <a
              href="#book"
